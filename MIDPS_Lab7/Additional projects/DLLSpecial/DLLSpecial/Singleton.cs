...
namespace DLLSpecial
{
    ...
    public class Singleton
    {
        ...
        private string connectionStringUsers = "Data Source=DESKTOP-FNFDKC7\\SQLEXPRESS;Initial Catalog=MiddleEarth;Integrated Security=True";
        ...
        public void saveToXML()
        {
            using (SqlConnection conn = new SqlConnection(connectionStringUsers))
            {
                ...
                {
                    SqlCommand sqlCmd = new SqlCommand(obj.select(), conn);
                    SqlDataAdapter sqlDataAdap = new SqlDataAdapter(sqlCmd);
                    DataSet dtRecord = new DataSet();
                    sqlDataAdap.Fill(dtRecord);
                ...
                using (SqlCommand sqlCmd = new SqlCommand("use MiddleEarth; SELECT * FROM Master2Ring", conn))
                {
